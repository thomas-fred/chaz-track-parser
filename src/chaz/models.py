...
def r_max(v_max: np.ndarray, latitude: np.ndarray) -> np.ndarray:
    ...
    Exponential model, fit to aircraft observation data.
    ...
    but it is working with northern hemisphere data and I cannot see how it
    could be correct for both hemispheres otherwise.
    """
